...
interface CreateAssistantShiftModalProps {
  open: boolean
  onClose: () => void
  onSave: (data: {
    doctorId: number
...
const CreateAssistantShiftModal: React.FC<CreateAssistantShiftModalProps> = ({ open, onClose, onSave }) => {
...
export default CreateAssistantShiftModal
